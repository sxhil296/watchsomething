...
const Header = () => {
  ...
  return (
    <header className="fixed px-4 md:px-6 py-2 w-full top-6 mb-6">
      <div className="flex justify-between items-center">
        <div className="flex gap-[10px] justify-center items-center">
          <Image
            ...
            alt="tv logo"
          />
          <div className="text-lg md:text-2xl font-bold text-white flex flex-col justify-center leading:4 md:leading-8">
            <p>Watch Something</p>
            <p>Wonderful</p>
          </div>
        </div>
